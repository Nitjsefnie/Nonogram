...
static const char __pyx_k_stored_backtrack[] = "stored_backtrack";
...
static PyObject *__pyx_n_s_stored_backtrack;
...
static int __pyx_pymod_exec_globalvars(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_globalvars},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_stored_backtrack, __pyx_k_stored_backtrack, sizeof(__pyx_k_stored_backtrack), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initglobalvars(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initglobalvars(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_globalvars(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_globalvars(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_globalvars(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'globalvars' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_globalvars(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("globalvars", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "globalvars")) {
      if (unlikely(PyDict_SetItemString(modules, "globalvars", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     pool = None
 */
  __pyx_t_1 = __Pyx_Py3MetaclassPrepare((PyObject *) NULL, __pyx_empty_tuple, __pyx_n_s_Global, __pyx_n_s_Global, (PyObject *) NULL, __pyx_n_s_globalvars, (PyObject *) NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 *     drawing = False
 */
  if (__Pyx_SetNameInClass(__pyx_t_1, __pyx_n_s_pool_size, __pyx_int_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 *     stored_backtrack = []
 */
  if (__Pyx_SetNameInClass(__pyx_t_1, __pyx_n_s_pool, Py_None) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *     stored_backtrack = []
 */
  if (__Pyx_SetNameInClass(__pyx_t_1, __pyx_n_s_drawing, Py_False) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 */
  ...
  if (__Pyx_SetNameInClass(__pyx_t_1, __pyx_n_s_stored_backtrack, __pyx_t_2) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     pool = None
 */
  __pyx_t_2 = __Pyx_Py3ClassCreate(((PyObject*)&__Pyx_DefaultClassType), __pyx_n_s_Global, __pyx_empty_tuple, __pyx_t_1, NULL, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Global, __pyx_t_2) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
